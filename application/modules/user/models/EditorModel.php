<?php
class User_Model_EditorModel {
	protected $_dbTableProduct;
	protected $_db;

	public function __construct()
	{
		$this->_dbTableProduct = new User_Model_DbTables_EditorModel();
	...
	public function getAccountSiswa($email) {
		$productTable = $this->_dbTableProduct;
		try {
			$result = $productTable->getAccountSiswa($email);
